...
extension SettingsViewController {
    ...
    override func tableView(
        ...
        var vm: SettingsRepresentable? = nil
        switch section {
        case .date:
        ...
        case .temperature:
            guard let tempratureMode = TemperatureMode(rawValue: indexPath.row) else {
                fatalError("Invalide IndexPath")
            }
            vm = SettingsTemperatureViewModel(temperatureMode: tempratureMode)
        }
        if let vm = vm {
